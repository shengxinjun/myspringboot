	...
	<div class="navbar-container ace-save-state" id="navbar-container">
		...
		<div class="navbar-header pull-left">
			<a href="${pageContext.request.contextPath }/event/list"
				class="navbar-brand"> <small> <i class="fa fa-leaf"></i> my admin
			</small>
			</a>
		</div>
			...
			<ul class="nav ace-nav">
				...
				<li class="light-blue dropdown-modal"><a data-toggle="dropdown"
					href="#" class="dropdown-toggle"> <img class="nav-user-photo"
						...
						alt="Jason's Photo" /> <span class="user-info"> <small>Welcome,<small id="nickname"></small></small>
...
<div class="main-container ace-save-state" id="main-container">
	...
	<div id="sidebar"
		...
		<ul class="nav nav-list">
			...
			<li class="open"><a href="#" class="dropdown-toggle"> <i
					class="menu-icon fa fa-desktop"></i> <span class="menu-text">
						Product</span> <b class="arrow fa fa-angle-down"></b>
			</a> <b class="arrow"></b>

				<ul class="submenu">

					<li class=""><a href="/product/list"> <i
							class="menu-icon fa fa-caret-right"></i> product list
					</a> <b class="arrow"></b></li>
