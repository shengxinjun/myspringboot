...
public class User extends TableImpl<UserRecord> {
     ...
     */
    public final TableField<UserRecord, String> TELEPHONE = createField("telephone", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

    /**
     * The column <code>test.user.imgs</code>.
     */
    public final TableField<UserRecord, String> IMGS = createField("imgs", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");
     ...
     */
    public final TableField<UserRecord, String> ROLE = createField("role", org.jooq.impl.SQLDataType.VARCHAR.length(1), this, "");
