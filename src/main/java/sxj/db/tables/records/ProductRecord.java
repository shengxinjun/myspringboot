...
public class ProductRecord extends UpdatableRecordImpl<ProductRecord> implements Record8<Integer, String, Double, Date, Date, Integer, String, Integer> {

    private static final long serialVersionUID = -655793064;
     ...
     */
    @Override
    public Row8<Integer, String, Double, Date, Date, Integer, String, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row8<Integer, String, Double, Date, Date, Integer, String, Integer> valuesRow() {
     ...
     */
    @Override
    public ProductRecord value5(Date value) {
        setCreateDate(value);
        return this;
    }
     ...
     */
    @Override
    public ProductRecord values(Integer value1, String value2, Double value3, Date value4, Date value5, Integer value6, String value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProductRecord(Integer id, String name, Double price, Date updateDate, Date createDate, Integer deleted, String type, Integer orderId) {
        super(Product.PRODUCT);
