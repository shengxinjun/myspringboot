...
public class OrderRecord extends UpdatableRecordImpl<OrderRecord> implements Record5<Integer, String, Double, Integer, Date> {
     ...
     */
    @Override
    public Row5<Integer, String, Double, Integer, Date> fieldsRow() {
     ...
     */
    @Override
    public Row5<Integer, String, Double, Integer, Date> valuesRow() {
     ...
     */
    @Override
    public OrderRecord values(Integer value1, String value2, Double value3, Integer value4, Date value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OrderRecord(Integer id, String name, Double totalPrice, Integer userId, Date date) {
        super(Order.ORDER);
